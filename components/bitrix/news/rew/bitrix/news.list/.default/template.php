    ...
    <div class="review-block" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
        <div class="review-text">
            ...
            <div class="review-block-title"><span class="review-block-name"><a
                        ...
                        class="review-block-description"><?= $arItem["DISPLAY_ACTIVE_FROM"] ?> <?= GetMessage('YEAR') ?>.,<?=$arItem["DISPLAY_PROPERTIES"]["POSITION"]["VALUE"]?> , <?=$arItem["DISPLAY_PROPERTIES"]["COMPANY"]["VALUE"]?></span>
            </div>
        ...
        <div class="review-img-wrap"><a href="<?= $arItem["DETAIL_PAGE_URL"] ?>"><img
                        src="<?= $src ?>"
                        alt="<?= $arItem["PREVIEW_PICTURE"]["ALT"] ?>"></a></div>
